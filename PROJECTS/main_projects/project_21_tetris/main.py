...
def draw_grid(surface, row, col):
    ...
    for i in range(row):
        ...
        for j in range(col):
            pygame.draw.line(surface, (128, 128, 128), (sx + j * 30, sy), (sx + j * 30, sy + play_width))     # vertical  line
...
def draw_window(surface):
    ...
    surface.blit(label, (top_left_x + play_height/2 - (label.get_width() / 2), 30))
